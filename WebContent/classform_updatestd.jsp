...
<body>
    ...
    <form id="test" action="webservlet?method=updatestudent" method="post" onsubmit="return check()">
    <fieldset>
        <legend>修改学生-家长</legend>
        <div class="form-row">
            <div class="field-label"><label for="field1">学号</label>:</div>
            <div class="field-widget"><input name="studentid" id="field1" class="required" value="<%=request.getParameter("studentid")%>" disabled="true"/></div>
            <div class="field-widget"><input type="hidden" name="studentid" id="field1" class="required" value="<%=request.getParameter("studentid")%>"/></div>
        	<span id="tip"></span>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">班级编号</label>:</div>
            <div class="field-widget"><input name="classid" id="field2" class="required" value="<%=request.getParameter("classid")%>"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">学生名字</label>:</div>
            <div class="field-widget"><input name="studentname" id="field3" class="required" value="<%=request.getParameter("studentname")%>"/></div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field1">手机号</label>:</div>
            <div class="field-widget"><input name="useraccount" id="field4" class="required" value="<%=request.getParameter("useraccount")%>" disabled="true"/>
            <input type="hidden" name="useraccount" id="field4" class="required" value="<%=request.getParameter("useraccount")%>" disabled="true"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">家长名字</label>:</div>
            <div class="field-widget"><input name="parentname" id="field5" class="required" value="<%=request.getParameter("parentname")%>"/></div>
        </div>
