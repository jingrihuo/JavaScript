...
<body>
    ...
    <form id="test" action="webservlet?method=insertclass" method="post" onsubmit="return check()">
    <fieldset>
        <legend>添加班级信息</legend>
        <div class="form-row">
            <div class="field-label"><label for="field1">班级编号</label>:</div>
            <div class="field-widget"><input name="classid" id="field1" class="required"/></div>
            <span id="tip"></span>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">班级名称</label>:</div>
            <div class="field-widget"><input name="classname" id="field2" class="required"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">班级描述</label>:</div>
            <div class="field-widget"><input name="classdetail" id="field3" class="required" /></div>
        </div>
