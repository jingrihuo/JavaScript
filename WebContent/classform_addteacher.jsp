...
<body>
    ...
    <form id="test" action="webservlet?method=insertteacher" method="post" onsubmit="return check()">
    <fieldset>
        <legend>添加教师</legend>
        <div class="form-row">
            <div class="field-label"><label for="field1">教师编号</label>:</div>
            <div class="field-widget"><input name="teacherid" id="field1" class="required"/></div>
            <span id="tip"></span>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">手机号</label>:</div>
            <div class="field-widget"><input name="useraccount" id="field2" class="required"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">教师名称</label>:</div>
            <div class="field-widget"><input name="teachername" id="field3" class="required" /></div>
        </div>
        <div class="form-row">
            <div class="field-label"><label for="field1">教师类型</label>:</div>
            <div class="field-widget"><input name="teachertype" id="field4" class="required"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">任课班级</label>:</div>
            <div class="field-widget"><input name="classid" id="field5" class="required"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">教学课程</label>:</div>
            <div class="field-widget"><input name="project" id="field6" class="required" /></div>
        </div>
        <div class="form-row">
