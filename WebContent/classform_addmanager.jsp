...
<body>
    ...
    <form id="test" action="webservlet?method=insertmanager" method="post" onsubmit="return check()">
    <fieldset>
        <legend>添加管理员信息</legend>
        <div class="form-row">
            <div class="field-label"><label for="field1">管理员账号</label>:</div>
            <div class="field-widget"><input name="manageraccount" id="field1" class="required"/></div>
           	<span id="tip"></span>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field2">学校编号</label>:</div>
            <div class="field-widget"><input name="schoolid" id="field2" class="required"/></div>
        </div>
        
        <div class="form-row">
            <div class="field-label"><label for="field3">管理员姓名</label>:</div>
            <div class="field-widget"><input name="managername" id="field3" class="required" /></div>
        </div>
